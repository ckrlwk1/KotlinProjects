package com.example.cp3.common
...
class Code(
    ...
    constructor(service: ServiceError, codeName: CodeName) : this(
        service = service,
        id = codeName.id,
        code = codeName.code,
    ...
    constructor(service: ServiceError, codeName: CodeName, message: String) : this(
        service = service,
        id = codeName.id,
        code = codeName.code,
        message = message
    ...
    constructor(service: ServiceError, codeName: CodeName, resultData: Any) : this(
        service = service,
        id = codeName.id,
        code = codeName.code,
        message = codeName.message,
    ...
    constructor(service: ServiceError, codeName: CodeName, resultData: Any, message: String) : this(
        service = service,
        id = codeName.id,
        code = codeName.code,
        message = message,
